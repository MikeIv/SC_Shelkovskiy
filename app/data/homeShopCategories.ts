...
export const homeShopCategories: HomeShopCategory[] = [
  {
    ...
    leftImageSrc: '/images/home/categories/women-left.png',
    leftImageAlt: 'Женская одежда — модель в платье',
    rightImageSrc: '/images/home/categories/women-right.png',
    rightImageAlt: 'Женская одежда — модель в белом костюме',
  },
  {
    id: 'men',
    title: 'Мужская одежда',
    leftImageSrc: '/images/home/categories/men-left.png',
    leftImageAlt: 'Мужская одежда — модель в пиджаке',
    rightImageSrc: '/images/home/categories/men-right.png',
    rightImageAlt: 'Мужская одежда — модель у моря',
  },
  {
    id: 'shoes',
    title: 'Обувь и сумки',
    leftImageSrc: '/images/home/categories/shoes-left.png',
    leftImageAlt: 'Обувь — кожаные туфли',
    rightImageSrc: '/images/home/categories/shoes-right.png',
    rightImageAlt: 'Сумка — кожаная модель полумесяц',
  },
  {
    id: 'home',
    title: 'Товары для дома',
    leftImageSrc: '/images/home/categories/home-left.png',
    leftImageAlt: 'Товары для дома — постельное бельё',
    rightImageSrc: '/images/home/categories/home-right.png',
  ...
  },
  {
    id: 'tech',
    title: 'Техника',
    leftImageSrc: '/images/home/categories/tech-left.png',
    leftImageAlt: 'Техника — электрогриль',
    rightImageSrc: '/images/home/categories/tech-right.png',
